...
// with rounded corners and motion blur, click ripples and the cursor glyph. The same shader serves the
// live preview and the export encoder; only the render target differs.
