...
/// notarised `Recordito-<version>.zip` and an `appcast.xml` manifest to every GitHub release, and
...
final class UpdateController: NSObject {
    ...
    /// What `Recordito/Info.plist` ships until `Scripts/generate-sparkle-keys.sh` has been run and
