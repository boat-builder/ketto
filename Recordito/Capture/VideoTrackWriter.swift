...
enum CaptureError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .screenRecordingDenied: return "Screen Recording permission is required. Enable Recordito in System Settings → Privacy & Security → Screen Recording."
        case .microphoneDenied: return "Microphone permission was denied. Enable Recordito in System Settings → Privacy & Security → Microphone, or turn off microphone recording."
